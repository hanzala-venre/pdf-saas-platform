...
import { CreditCard, Calendar, TrendingUp, AlertTriangle, Crown, CheckCircle, XCircle, RefreshCw } from "lucide-react"
...
export default function BillingPage() {
  ...
  const fetchBillingData = async () => {
    try {
      const [subRes, usageRes] = await Promise.all([fetch("/api/billing/subscription"), fetch("/api/billing/usage")])
  ...
  const handleChangePlan = async (newPlan: string) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Plan Updated",
          description: result.message || `Successfully changed to ${newPlan} plan.`,
        })
        fetchBillingData()
      } else {
            ...
            {subscription?.cancelAtPeriodEnd && (
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                ...
                <p className="text-amber-700 mt-1">
                  Your subscription will end on {new Date(subscription.currentPeriodEnd!).toLocaleDateString()}. You can
                ...
                <>
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <Button className="bg-purple-600 hover:bg-purple-700">Upgrade to Monthly</Button>
                    </AlertDialogTrigger>
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Upgrade to Monthly Pro</AlertDialogTitle>
                        <AlertDialogDescription>
                          You'll be charged $1.99/month and gain unlimited PDF processing, priority support, and advanced features. You can cancel anytime.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                        <AlertDialogAction asChild>
                          <a href="/api/stripe/checkout?plan=monthly" className="bg-purple-600 hover:bg-purple-700">
                            Upgrade Now
                          </a>
                        </AlertDialogAction>
                      </AlertDialogFooter>
                  ...
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <Button variant="outline" className="bg-transparent">Upgrade to Yearly</Button>
                    </AlertDialogTrigger>
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Upgrade to Yearly Pro</AlertDialogTitle>
                        <AlertDialogDescription>
                          You'll be charged $19.99/year (save $4.89 compared to monthly) and gain unlimited PDF processing, priority support, and advanced features. You can cancel anytime.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                        <AlertDialogAction asChild>
                          <a href="/api/stripe/checkout?plan=yearly" className="bg-green-600 hover:bg-green-700">
                            Upgrade Now
                          </a>
                        </AlertDialogAction>
                      </AlertDialogFooter>
                ...
                <>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Are you sure you want to cancel your subscription? You'll continue to have access until the
                            end of your current billing period, then your account will revert to the free plan.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                  ...
                  {subscription?.plan === "monthly" && (
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>Switch to Yearly Plan</AlertDialogTitle>
                          <AlertDialogDescription>
                            You'll be upgraded to the Yearly Pro plan ($19.99/year) and save $4.89 compared to monthly billing. The change will be prorated based on your current billing cycle.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>Cancel</AlertDialogCancel>
                  ...
                  {subscription?.plan === "yearly" && (
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>Switch to Monthly Plan</AlertDialogTitle>
                          <AlertDialogDescription>
                            You'll be downgraded to the Monthly Pro plan ($1.99/month). This change will take effect at the end of your current billing period to avoid losing any paid time.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>Cancel</AlertDialogCancel>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm">Invoices are sent to your email address</p>
              </div>
            </CardContent>
          </Card>
        )}
